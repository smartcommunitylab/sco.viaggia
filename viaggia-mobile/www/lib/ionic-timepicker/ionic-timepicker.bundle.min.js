    ...
    function t(t) {
        return {
            ...
            link: function (e, i, n) {
                ...
                e.inputEpochTime = e.inputObj.inputEpochTime ? e.inputObj.inputEpochTime : o, e.step = e.inputObj.step ? e.inputObj.step : 15, e.format = e.inputObj.format ? e.inputObj.format : 24, e.titleLabel = e.inputObj.titleLabel ? e.inputObj.titleLabel : "Time Picker", e.setLabel = e.inputObj.setLabel ? e.inputObj.setLabel : "Set", e.closeLabel = e.inputObj.closeLabel ? e.inputObj.closeLabel : "Close", e.setButtonType = e.inputObj.setButtonType ? e.inputObj.setButtonType : "button-positive", e.closeButtonType = e.inputObj.closeButtonType ? e.inputObj.closeButtonType : "button-stable";
                var s = {
                ...
                e.increaseHours = function () {
                    ...
                    e.time.hours = Number(e.time.hours), 12 == s.format && (e.time.hours > 1 ? e.time.hours -= 1 : e.time.hours = 12), 24 == s.format && (e.time.hours = (e.time.hours + 23) % 24), e.time.hours = e.time.hours < 10 ? "0" + e.time.hours : e.time.hours
                    ...
                    u = "undefined" == typeof e.inputObj.inputEpochTime || null === e.inputObj.inputEpochTime ? new Date : new Date(1e3 * e.inputObj.inputEpochTime), 12 == s.format ? (e.time.meridian = u.getUTCHours() >= 12 ? "PM" : "AM", e.time.hours = u.getUTCHours() > 12 ? u.getUTCHours() - 12 : u.getUTCHours(), e.time.minutes = u.getUTCMinutes(), e.time.hours = e.time.hours < 10 ? "0" + e.time.hours : e.time.hours, e.time.minutes = e.time.minutes < 10 ? "0" + e.time.minutes : e.time.minutes, 0 === e.time.hours && "AM" === e.time.meridian && (e.time.hours = 12), t.show({
                    ...
                    })) : 24 == s.format && (e.time.hours = u.getUTCHours(), e.time.minutes = u.getUTCMinutes(), e.time.hours = e.time.hours < 10 ? "0" + e.time.hours : e.time.hours, e.time.minutes = e.time.minutes < 10 ? "0" + e.time.minutes : e.time.minutes, t.show({
