        ...
        try {
            cookieMaster.clear(
                function () {
                    ...
                    //tmp disabled, we need the functionality on server
...
.factory('userService', function ($http, $q, Config, storageService) {
    ...
    .factory('storageService', function ($http, $q, Config) {
        ...
        storageService.deleteTrips = function() {
            localStorage.removeItem(Config.getAppId() + "_savedTrips");
        }
        ...
        storageService.deleteUserId = function () {
