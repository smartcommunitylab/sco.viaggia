...
angular.module('viaggia', [
  ...
  .config(function ($stateProvider, $compileProvider, $urlRouterProvider, $translateProvider, $ionicConfigProvider) {
    ...
    $translateProvider.translations('it', {
      ...
      msg_trip_multimodal: 'Viaggio pianificato. Ore {{time}}. {{travelValidity}}',
    ...
    $translateProvider.translations('en', {
      ...
      gps_disabled_template: "The geolocation permissions are disabled. The current trip tracking has been interrupted. Before starting new trips, it is necessary to enable geolocation.",
      ...
      msg_trip_multimodal: 'Planned trip. At {{time}}. {{travelValidity}}',
