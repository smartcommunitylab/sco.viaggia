...
.run(function ($ionicPlatform, $cordovaFile, $rootScope, $translate, trackService, DataManager, Config, GeoLocate, notificationService) {
    ...
    .config(function ($stateProvider, $urlRouterProvider, $translateProvider, $ionicConfigProvider) {
        ...
        $translateProvider.translations('it', {
            ...
            add_favorites_template: 'Vuoi aggiungere l\'indirizzo ai tuoi favoriti?',
            add_favorites_title: 'Aggiungi a favoriti',
            ...
            popup_delete_favorite: 'Sicuro di cancellare il favorito?',
            ...
            favorites_empty_list: 'Nessun indirizzo favorito. Torna alla pagina <i>Pianifica itinerario</i>, inserisci un indirizzo e clicca sulla stella per definirlo favorito.',
            ...
            favorites_title_list: 'Indirizzi favoriti',
        ...
        $translateProvider.translations('en', {
            ...
            my_trip_to: 'To',
            my_trip_time: 'Start',
            favorites_empty_list: 'No saved favorites. Go back to <em>Plan Journey</em>, insert an address and click on the star to define it as a favorite.',
            ...
            registration_answer: 'Respond to these quick and easy questions in order to register for the game. The answers will let the system to offer the service that fits better your needs and preferences.',
            registration_read: 'I have read and agreed to the game terms and conditions and to the privacy policy:',
            ...
            registration_km_placeholder: 'Insert average distance in km medi travelled daily',
