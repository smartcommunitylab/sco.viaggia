...
angular.module('viaggia', [
  ...
  .config(function ($stateProvider, $compileProvider, $urlRouterProvider, $translateProvider, $ionicConfigProvider) {
    ...
    $translateProvider.translations('it', {
      ...
      warning_choose_challenge: "Programma la sfida per la prossima settimana. Se non avrai scelto una sfida, alle ... di venerdì il sistema ti assegnerà in automatico una sfida individuale",
      read_more: "altro",
    ...
    $translateProvider.translations('en', {
      ...
      warning_choose_challenge: "Plan next week's challenge. If you don't choose a challenge before Friday at ... the system will automatically assign a single-player challenge",
      read_more: "read more",
      ...
      challenge_accept_popup_template: "If you confirm this challenge, all other options will be automatically delated",
